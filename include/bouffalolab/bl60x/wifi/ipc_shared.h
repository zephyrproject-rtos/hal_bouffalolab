...
/* The firmware ABI lists are plain {first, last} singly-linked lists, which
 * sys_slist_t/sys_snode_t match exactly.
 */
struct ipc_shared_env_tag
{
    ...
    /* List of free txdesc */
    sys_slist_t list_free;
    /* List of ongoing txdesc */
    sys_slist_t list_ongoing;
    /* List of cfm txdesc */
    sys_slist_t list_cfm;
};
