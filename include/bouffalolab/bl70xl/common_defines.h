 ...
 * BL70XL-specific defines (same as BL70X - they share peripherals)
...
/* timer_reg.h — BL702L uses 4-bit clock source fields at different positions than BL702 */
...
/* pwm_v1_reg.h */
#define PWM_INT_CONFIG_OFFSET (-0x20)
