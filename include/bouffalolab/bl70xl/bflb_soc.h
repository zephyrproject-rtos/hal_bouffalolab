...
/* Define ARCH_RISCV for the hardware headers */
#ifndef ARCH_RISCV
#define ARCH_RISCV
#endif
...
#endif
/**
 * @brief BL70XL Interrupt Number Definition, according to the selected device
...
#endif
    /******  BL70XL specific Interrupt Numbers **********************************************************************/
...
/**
 * @brief BL70XL Memory Map Definitions
 */
#define BL70XL_FLASH_XIP_BASE        0x23000000
#define BL70XL_FLASH_XIP_END         (0x23000000 + 16 * 1024 * 1024)
#define BL70XL_FLASH_XIP_REMAP0_BASE 0x33000000
#define BL70XL_FLASH_XIP_REMAP0_END  (0x33000000 + 16 * 1024 * 1024)
#define BL70XL_FLASH_XIP_REMAP1_BASE 0x43000000
#define BL70XL_FLASH_XIP_REMAP1_END  (0x43000000 + 16 * 1024 * 1024)
#define BL70XL_FLASH_XIP_REMAP2_BASE 0x53000000
#define BL70XL_FLASH_XIP_REMAP2_END  (0x53000000 + 16 * 1024 * 1024)

#define BL70XL_PSRAM_XIP_BASE        0x24000000
#define BL70XL_PSRAM_XIP_END         (0x24000000 + 16 * 1024 * 1024)
#define BL70XL_PSRAM_XIP_REMAP0_BASE 0x34000000
#define BL70XL_PSRAM_XIP_REMAP0_END  (0x34000000 + 16 * 1024 * 1024)
#define BL70XL_PSRAM_XIP_REMAP1_BASE 0x44000000
#define BL70XL_PSRAM_XIP_REMAP1_END  (0x44000000 + 16 * 1024 * 1024)
#define BL70XL_PSRAM_XIP_REMAP2_BASE 0x54000000
#define BL70XL_PSRAM_XIP_REMAP2_END  (0x54000000 + 16 * 1024 * 1024)

#define BL70XL_WRAM_BASE        0x42020000
#define BL70XL_WRAM_END         (0x42020000 + 80 * 1024)
#define BL70XL_WRAM_REMAP0_BASE 0x22020000
#define BL70XL_WRAM_REMAP0_END  (0x22020000 + 80 * 1024)
#define BL70XL_WRAM_REMAP1_BASE 0x32020000
#define BL70XL_WRAM_REMAP1_END  (0x32020000 + 80 * 1024)
#define BL70XL_WRAM_REMAP2_BASE 0x52020000
#define BL70XL_WRAM_REMAP2_END  (0x52020000 + 80 * 1024)

#define BL70XL_TCM_BASE        0x2201c000
#define BL70XL_TCM_END         (0x2201c000 + 16 * 1024)
#define BL70XL_TCM_REMAP0_BASE 0x3201c000
#define BL70XL_TCM_REMAP0_END  (0x3201c000 + 16 * 1024)
#define BL70XL_TCM_REMAP1_BASE 0x4201c000
#define BL70XL_TCM_REMAP1_END  (0x4201c000 + 16 * 1024)
#define BL70XL_TCM_REMAP2_BASE 0x5201c000
#define BL70XL_TCM_REMAP2_END  (0x5201c000 + 16 * 1024)
/*@} end of group Memory_Map_Section */

/* BL70XL peripherals base address */
