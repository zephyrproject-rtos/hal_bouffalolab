...
#ifndef __BL616CL_H__
#define __BL616CL_H__
...
#endif
/**
 * @brief BL616CLL Interrupt Number Definition, according to the selected device
...
#endif
    /******  BL616CLL specific Interrupt Numbers **********************************************************************/
...
/**
 * @brief BL616CLL Memory Map Definitions
 */
#define BL616CL_OCRAM_BASE                     (0x20FC0000)
#define BL616CL_OCRAM_END                      (0x20FC0000 + 224 * 1024)
#define BL616CL_OCRAM_CACHEABLE_BASE           (0x60FC0000)
#define BL616CL_OCRAM_CACHEABLE_END            (0x60FC0000 + 224 * 1024)

#define BL616CL_WRAM_BASE                      (0x20FF8000)
#define BL616CL_WRAM_END                       (0x20FF8000 + 160 * 1024)
#define BL616CL_WRAM_CACHEABLE_BASE            (0x60FF8000)
#define BL616CL_WRAM_CACHEABLE_END             (0x60FF8000 + 160 * 1024)

#define BL616CL_FLASH_XIP_BASE                 (0x80000000)
#define BL616CL_FLASH_XIP_END                  (0x80000000 + 64 * 1024 * 1024)

#define BL616CL_FLASH2_XIP_BASE                (0x84000000)
#define BL616CL_FLASH2_XIP_END                 (0x84000000 + 64 * 1024 * 1024)

#define BL616CL_PSRAM_BASE                     (0x88000000)
#define BL616CL_PSRAM_END                      (0x88000000 + 128 * 1024 * 1024)

#define BL616CL_ALLRAM_BASE                    (0x20FC0000)
#define BL616CL_ALLRAM_END                     (0x20FC0000 + 224 * 1024 + 160 * 1024)
#define BL616CL_ALLRAM_CACHEABLE_BASE          (0x60FC0000)
#define BL616CL_ALLRAM_CACHEABLE_END           (0x60FC0000 + 224 * 1024 + 160 * 1024)

/*@} end of group Memory_Map_Section */


/* BL616CLL peripherals base address */
/* WLSYS */
