 ...
 */
int wl80211_supplicant_set_sta_key_internal(uint8_t vif_idx, uint8_t sta_idx, bflb_wpa_alg_t alg, int key_idx, int set_tx, uint8_t *seq,
 ...
 */
int wl80211_supplicant_set_ap_key_internal(uint8_t vif_idx, uint8_t sta_idx, bflb_wpa_alg_t alg, int key_idx, uint8_t *key,
