...
/* MCS-to-rate tables in 100 kbps units, BW20, NSS=1, long GI */
static const uint16_t HT_RATE_KBPS_BW20[8] = {
	65, 130, 195, 260, 390, 520, 585, 650,
};
static const uint16_t VHT_RATE_KBPS_BW20[10] = {
	65, 130, 195, 260, 390, 520, 585, 650, 780, 867,
};
static const uint16_t HE_RATE_KBPS_BW20[12] = {
	86, 172, 258, 344, 516, 688, 774, 860, 1032, 1147, 1290, 1434,
};
static const uint16_t NONHT_OFDM_KBPS[8] = {
	60, 90, 120, 180, 240, 360, 480, 540,
};

/* 802.11b/g supported rates in 100 kbps units */
static const uint16_t BG_RATES_100KBPS[12] = {
